...
hi clear
syntax reset
let g:colors_name = "minciue-base16"
...
call <SID>hi("MatchParen",    s:gui0A, s:gui01, s:cterm03, s:cterm00,  "reverse")
...
if &background == "dark"
  ...
  if version >= 700
    call <SID>hi("ColorColumn",  "", s:gui01, s:cterm00, s:cterm00, "none")
    call <SID>hi("CursorColumn",  "", s:gui01, s:cterm03, "", "none")
"    call <SID>hi("CursorLine",    "", s:gui01, "", s:cterm03, "none")
    call <SID>hi("PMenu",         s:gui04, s:gui01, s:cterm03, s:cterm00, "none")
    call <SID>hi("PMenuSel",      s:gui04, s:gui01, s:cterm00, s:cterm01, "none")

    call <SID>hi("TabLine",       s:gui05, s:gui01, s:cterm03, s:cterm00, "none")
    call <SID>hi("TabLineFill",   s:gui06, s:gui01, s:cterm03, s:cterm00, "none")
    call <SID>hi("TabLineSel",    s:gui06, s:gui01, s:cterm01, s:cterm00, "none")
  endif
else
...
" TODO here
call <SID>hi("Todo",         s:gui0A, s:gui01, s:cterm07, s:cterm08, "")
